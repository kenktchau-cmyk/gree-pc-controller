...
public class GreeCommunicationService {
    ...
    public synchronized <T> T sendCommand(GreeAirconditionerDevice device, Command command, Function<String, T> function) {
        ...
        try {
            ...
            throw new IllegalStateException("The air conditioner did not respond. Try again.", e);
        }
    }
}
